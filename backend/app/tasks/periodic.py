...
async def check_deadline_reminders():
    ...
    async with async_session() as db:
        ...
        for user in users:
            # Get deadlines due in reminder days
...
@celery_app.task
async def calculate_focus_scores():
...
async def check_medication_reminders():
    ...
    async with async_session() as db:
        ...
        for medication in medications:
            # Send reminders based on time_of_day
...
@celery_app.task
async def sync_single_calendar(connection_id: str):
    """
