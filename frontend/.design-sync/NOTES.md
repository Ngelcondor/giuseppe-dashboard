...
- **Token `@kind` tagging — `annotate-tw.mjs` (LAST step of the ds.css regen above).** The Claude
  Design adherence check (`_adherence.oxlintrc.json` `x-omelette.tokenKinds`, regenerated by the app
