  ...
  return (
    <div className="min-h-screen bg-[#0f1117] text-slate-100">
      <header className="px-6 py-5 border-b border-white/5 flex items-center gap-3">
        ...
        <h1 className="text-base font-semibold">Sensoriale</h1>
      </header>
      <main className="max-w-xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-sm font-medium text-slate-300 mb-2">Sensoriale</p>
        <p className="text-xs text-slate-600">Log per il carico sensoriale e la regolazione.</p>
