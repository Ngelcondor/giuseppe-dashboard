  ...
  return (
    <div className="min-h-screen bg-[#0f1117] text-slate-100">
      ...
      <main className="max-w-xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-sm font-medium text-slate-300 mb-2">Cyber Feed</p>
        <p className="text-xs text-slate-600">Notizie e aggiornamenti dal mondo della cybersecurity.</p>
