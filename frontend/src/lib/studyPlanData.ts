...
export const CRTP_PLAN: StudyPhaseSeed[] = [
  {
    ...
    description: 'Settimana di preparazione: VM, GOAD, tool arsenal, workspace',
    ...
    weeks: [
      {
        ...
        days: [
          {
            date: '2026-04-28',
            label: 'Mar 28 Apr — Mac + Parallels base',
            hours: '3-4h',
            tasks: [
              'Verifica Kali Parallels VM funzionante (10.211.55.4)',
              'Aggiorna Kali: sudo apt update && sudo apt full-upgrade -y',
              'Crea snapshot Kali base: "Kali-Pre-CRTP-Clean"',
              'Crea VM Windows 11 (per testing PowerShell)',
              'Snapshot Windows: "Win11-Clean"',
            ],
          },
          {
            date: '2026-04-29',
            label: 'Mer 29 Apr — GOAD Setup',
            hours: '4-6h',
            tasks: [
              'Clone repo: git clone https://github.com/Orange-Cyberdefense/GOAD ~/GOAD',
              'Leggi README completo',
              'Decisione architettura: GOAD-Light su Parallels o cloud AWS/Azure',
              'Predisponi 32GB RAM minimo',
              'Avvia provisioning (4-6h unattended)',
            ],
          },
          {
            date: '2026-04-30',
            label: 'Gio 30 Apr — Tool Arsenal',
            hours: '3-4h',
            tasks: [
              ...
              'Crea cheatsheet personale tools-arsenal.md',
              'Verifica AV Mac non blocca i binari',
            ],
          },
          {
            date: '2026-05-01',
            label: 'Ven 1 Mag — TryHackMe + HackTheBox',
            hours: '1h',
            tasks: [
              'Verifica subscription TryHackMe attiva',
              'Bookmark room: AD Basics',
              'Bookmark room: Attacking Kerberos',
              'Bookmark room: Attacktive Directory',
              'Crea account HackTheBox Academy (free)',
              'Bookmark moduli AD HTB Academy',
            ],
          },
          {
            date: '2026-05-02',
            label: 'Sab 2 Mag — Workspace + Calendario',
            tasks: [
              'Imposta Notion/Obsidian con struttura cartelle',
              'Crea calendario CRTP nel tuo iCloud/Google Calendar',
              'Color code: 🔵 teoria, 🟢 lab, 🔴 esame',
              'Blocca slot studio quotidiano',
              'Imposta Apple Watch reminder pomodoro (45 min)',
              'Iscriviti a r/redteamsec',
              'Iscriviti a r/AskNetsec',
          ...
          {
            date: '2026-05-03',
            label: 'Dom 3 Mag — RIPOSO ATTIVO',
            isRest: true,
            tasks: ['Camminate, vita sociale, NO cybersec'],
          },
          {
            date: '2026-05-04',
            label: 'Lun 4 Mag — RIPOSO ATTIVO',
            isRest: true,
            tasks: ['Prepara mentalmente: il 5 maggio si parte sul serio'],
          },
        ],
      },
    ],
